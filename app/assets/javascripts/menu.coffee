...
#do ->
  ...
  #init = ->
    ...
    #perspectiveWrapper = document.getElementById('page-top')
    ...
    #showMenu.addEventListener clickevent, (ev) ->
      ...
      #), 25
      #return
    #container.addEventListener clickevent, (ev) ->
      #if classie.has(perspectiveWrapper, 'animate')

        #onEndTransFn = (ev) ->
          #if support and (ev.target.className != 'container' or ev.propertyName.indexOf('transform') == -1)
            #return
      ...
      #return
    #perspectiveWrapper.addEventListener clickevent, (ev) ->
      #false
    #return
